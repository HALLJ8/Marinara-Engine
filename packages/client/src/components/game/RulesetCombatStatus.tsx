...
export function RulesetCombatStatus({
  ...
  return (
    <div className="mt-2 space-y-2">
      ...
      <ol aria-label={t("game.combat.ruleset.status.order")} className="flex flex-wrap gap-1.5">
        {order.map((combatant) => {
          ...
          return (
            <li
              ...
              className={cn(
                "min-w-[9rem] flex-1 rounded-lg border px-2 py-1.5 text-xs",
                onTurn
      ...
      <section aria-label={t("game.combat.ruleset.log.title")}>
