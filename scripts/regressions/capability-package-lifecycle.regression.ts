...
try {
  ...
  assert.deepEqual(supportedCapabilityApi, { major: 1, minor: 27 });
  ...
  assert.match(
    ...
    /requires capability API 2\.0; this Engine supports 1\.27/,
  );
  ...
  assert.match(
    ...
    /requires capability API 1\.28; this Engine supports 1\.27/,
  );
