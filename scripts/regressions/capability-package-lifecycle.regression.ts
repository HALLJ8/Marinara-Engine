...
try {
  ...
  assert.deepEqual(supportedCapabilityApi, { major: 1, minor: 29 });
  ...
  assert.match(
    ...
    /requires capability API 2\.0; this Engine supports 1\.29/,
  );
  ...
  assert.match(
    ...
    /requires capability API 1\.30; this Engine supports 1\.29/,
  );
