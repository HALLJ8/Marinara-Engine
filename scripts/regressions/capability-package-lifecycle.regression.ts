...
try {
  ...
  assert.deepEqual(supportedCapabilityApi, { major: 1, minor: 31 });
  ...
  assert.match(
    ...
    /requires capability API 2\.0; this Engine supports 1\.31/,
  );
  ...
  assert.match(
    ...
    /requires capability API 1\.32; this Engine supports 1\.31/,
  );
