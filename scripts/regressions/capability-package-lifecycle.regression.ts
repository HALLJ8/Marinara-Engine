...
try {
  ...
  assert.deepEqual(supportedCapabilityApi, { major: 1, minor: 25 });
  ...
  assert.match(
    ...
    /requires capability API 2\.0; this Engine supports 1\.25/,
  );
  ...
  assert.match(
    ...
    /requires capability API 1\.26; this Engine supports 1\.25/,
  );
