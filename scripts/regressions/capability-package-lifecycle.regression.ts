...
try {
  ...
  assert.deepEqual(supportedCapabilityApi, { major: 1, minor: 30 });
  ...
  assert.match(
    ...
    /requires capability API 2\.0; this Engine supports 1\.30/,
  );
  ...
  assert.match(
    ...
    /requires capability API 1\.31; this Engine supports 1\.30/,
  );
